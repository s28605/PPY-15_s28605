...
Original file is located at
    https://colab.research.google.com/drive/1B6JJAXLxuuDm6l2oMLET9TQZfT6SrMzV
...
"""Exercise 4. <br />
Change the code so that there are two inputs and the first number if can be divisible numer.
"""

f_number = int(input("Enter a first number: "))
s_number = int(input("Enter a second number: "))
